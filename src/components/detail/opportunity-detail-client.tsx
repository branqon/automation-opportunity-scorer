    ...
    <div className="space-y-5">
      ...
      <SurfaceCard className="relative overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at top right, var(--ambient-primary) 0%, transparent 34%), linear-gradient(180deg, color-mix(in srgb, var(--surface-elevated) 84%, transparent) 0%, transparent 100%)",
          }}
        />
      ...
      <section className="grid gap-5 xl:grid-cols-[minmax(0,1.05fr)_minmax(320px,0.95fr)] xl:items-start">
        <div className="order-2 xl:order-1">
          <ScoreBreakdown opportunity={opportunity} />
        </div>

        <SurfaceCard className="order-1 space-y-4 bg-surface-elevated xl:order-2">
          <div>
            <p className="text-xs font-medium uppercase tracking-[0.14em] text-muted-foreground">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {neighboring.higher ? (
              <Link
                ...
                prefetch={false}
                className="rounded-card border border-line bg-surface-subtle p-3 transition hover:border-accent/25 hover:bg-surface"
              >
              ...
              <div className="rounded-card border border-dashed border-line bg-surface-subtle/40 p-3">
      ...
      <section className="grid gap-5 xl:grid-cols-2">
        <SurfaceCard className="space-y-4 bg-surface-elevated">
            <div>
              <p className="text-xs font-medium uppercase tracking-[0.14em] text-muted-foreground">
                ROI assumptions
              </p>
